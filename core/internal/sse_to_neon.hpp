...
// halismai XXX
inline __m128i _mm_set1_epi8(const uint8_t v) { return vmovq_n_s16(v); }
...
// halismai XXX
inline void _mm_store_si128(__m128i* p, const __m128& a)
{
...
{
  return _mm_loadu_si128( const_cast<__m128i*>(p) );
}
...
inline __m128i _mm_load_si128(const __m128* p)
{
  return _mm_load_si128((__m128*) p);
}
...
// halismai XXX
inline __m128i _mm_max_epu8(const __m128i& a, const __m128i& b)
{
  return vmaxq_u16(a, b);
}

// halismai XXX
inline __m128i _mm_min_epu8(const __m128i& a, const __m128i& b)
{
  return vminq_u16(a, b);
}

// halismai XXX
inline __m128i _mm_cmpeq_epi8(const __m128i& a, const __m128i& b)
{
  return vceqq_s16(a, b);
}

// halismai XXX
inline __m128i _mm_andnot_si128(const __m128i& a, const __m128i& b)
{
  return (__m128i) vbicq_s32(b, a);
}

// halismai XXX
inline __m128i _mm_and_si128(const __m128i& a, const __m128i& b)
{
...
/*inline __m128i _mm_srli_epi32(const __m128i& a, const int imm)
{
  return vshrq_n_u32(a, imm);
}
*/

inline __m128i _mm_xor_si128(const __m128i& a, const __m128i& b)
{
  return veorq_s32(a, b);
}

inline __m128i _mm_or_si128(const __m128i& a, const __m128i& b)
{
