...
#ifndef BITPLANES_INTERNAL_CHANNEL_DATA_FAST_H
#define BITPLANES_INTERNAL_CHANNEL_DATA_FAST_H
...
template <class M>
class BitPlanesChannelDataFast
{
 public:
 ...
 public:
  BitPlanesChannelDataFast() = default;
  ...
  void linearize(const cv::Mat& Iw, Gradient&) const;
