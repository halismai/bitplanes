...
IF(CMAKE_SYSTEM_NAME MATCHES "Linux")
  ...
  IF (SSE42_TRUE)
    ...
    set(SSE4_2_FLAGS "-msse4.2")
  ELSE (SSE42_TRUE)
    set(SSE4_2_FOUND false CACHE BOOL "SSE4.2 available on host")
  ENDIF (SSE42_TRUE)

  STRING(REGEX REPLACE "^.*(popcnt).*$" "\\1" SSE_THERE ${CPUINFO})
  STRING(COMPARE EQUAL "popcnt" "${SSE_THERE}" POPCNT_TRUE)
  IF (POPCNT_TRUE)
    set(POPCNT_FOUND true CACHE BOOL "popcnt available on host")
  ELSE (POPCNT_TRUE)
    set(POPCNT_FOUND false CACHE BOOL "popcnt available on host")
  ENDIF (POPCNT_TRUE)
